({
    render: function(component, helper) {
        ...
        var BASE_URL = '/resource/SLDS/assets';
        ...
        if (!component.get('v.iconContainer')) {
            ...
            var containerClass = '';
            if (component.get('v.iconContainerClass') != 'none'){
        ...
        // var assistiveText = '';
        // var setAssistiveText = component.get('v.assistiveText');
        // // If assistive text added
        // if (setAssistiveText != "") {
        //     assistiveText = document.createElement('span');
        //     assistiveText.setAttribute('class', 'slds-assistive-text');
        //     assistiveText.innerText = setAssistiveText;
